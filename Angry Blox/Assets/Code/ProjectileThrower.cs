...
public class ProjectileThrower : MonoBehaviour {
    ...
    {
        // returns true if there is any awake RigidBody2D on screen
    ...
    {
        FireControl();
        // reloads the level if escape key pressed or the projectile has been fired (firingState is at Firing or beyond)
        // and we aren’t waiting for physics to settle.
